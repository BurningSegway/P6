...
class RewardsCfg:
    ...
    reaching_object_fine = RewTerm(func=mdp.object_ee_distance, params={"std": 0.07}, weight=20.0)

    reaching_object_rough = RewTerm(func=mdp.object_ee_distance, params={"std": 0.3}, weight=10.0)
    ...
    #ee_ori = RewTerm(func=mdp.ee_orientation, weight=1)
...
class TerminationsCfg:
    ...
    termination_cfg = DoneTerm(func=mdp.object_out_of_offset_circle, params={"center": (0.5, 0.0), "radius": 0.45}, time_out=False)
